...
@section('maintab')
    <div class="mainTabs">
        ...
        <form action="{{ route('news.update', $news->id) }}" method="POST" class="p-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3 d-flex gap-3 flex-column">
                ...
                <div class="col">
                    ...
                    <input id="title" placeholder="Title" type="text"
                        class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $news->name }}"
                        required autofocus>
                ...
                <div class="col">
                    ...
                    <textarea id="description" placeholder="Description" class="form-control @error('description') is-invalid @enderror"
                        name="description" required>{{ $news->description }}</textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col">
                    ...
                    @if ($news->image_path)
                        <div class="mb-3">
                            <img src="{{ asset('storage/public/' . $news->image_path) }}" alt="Current Image"
