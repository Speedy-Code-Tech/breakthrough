                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('announcement.edit', $item->id) }}" class="btn btn-warning">EDIT</a>
                                <a href="{{ route('announcement.destroy', $item->id) }}" class="btn btn-danger delete-news"
                                    data-id="{{ $item->id }}" onclick="event.preventDefault();">
                                    DELETE
                                </a>

                                <form id="delete-form-{{ $item->id }}"
                                    action="{{ route('announcement.destroy', $item->id) }}" method="POST"
                                    style="display: none;">
                                    @csrf
                                </form>
