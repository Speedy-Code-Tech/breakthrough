...
@section('maintab')
    <div class="mainTabs">
        ...
        <form action="{{ route('entertainment.update', $items->id) }}" method="POST" class="p-5" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row mb-3 d-flex gap-3 flex-column">
                ...
                <div class="col">
                    ...
                    <input id="title" placeholder="Title" type="text"
                        class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $items->name }}"
                        required autofocus>
                ...
                <div class="col">
                    ...
                    @if ($items->image_path)
                        <div class="mb-3">
                            <img src="{{ asset('storage/public/' . $items->image_path) }}" alt="Current Image"
